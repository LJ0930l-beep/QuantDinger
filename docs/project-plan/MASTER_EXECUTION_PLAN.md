...
| RF-01A | DONE | 锁定权威 Risk Facts 来源、scope、版本、陈旧性和回放合同 | `c211c6a`；EXEC-13 BLOCKED | 纯合同、来源 Schema、迁移镜像、测试 | Runtime Provider、入口接入、Live | 来源矩阵与 append-only 来源合同 | PR #27、Backend/Security CI、Guard=46 | RF-01A Contract Lock Gate PASS | 来源歧义、宽松回退、伪造事实 | 后端 | merged PR #27 | `1b836d1` |
| RF-01B | IN_PROGRESS | 实现 caller-owned Runtime Risk Facts Provider、provenance 与容量串行化 | RF-01A DONE | Provider、repository、并发/回放测试、必要的来源扩展 Schema | Runtime 下单、Exchange 写、Live | 权威 Provider 与 provenance 链 | PostgreSQL replay/rollback/concurrency、CI | RF-01 Gate | raw driver、无权威来源、容量锁提前释放 | 后端 | `phase0/rf-01b-runtime-risk-facts` / Draft TBD | `1b836d1` |
...
| 2026-07-30 | DONE / IN_PROGRESS | `1b836d1` | PR #27 merged / RF-01B Draft（待创建） | RF-01A Backend CI、Security CI、Guard=46；RF-01A tree parity verified | RF-01A 已合并；RF-01B 继续 caller-owned Provider、provenance 与容量串行化；EXEC-13 仍 BLOCKED；Live OFF |
