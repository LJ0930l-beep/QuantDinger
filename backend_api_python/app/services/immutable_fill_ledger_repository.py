...
class ImmutableFillLedgerRepository:
        ...
        *,
        ...
        try:
            ...
            if not inserted:
                ...
                connection.commit()
                return result
            evidence_ids = self._insert_valuation_evidence(cursor, fill_event_id, fill)
            self._insert_fee_components(cursor, fill_event_id, fill, evidence_ids)
    ...
    def _insert_fill(
        ...
        cursor.execute(
            ...
            INSERT INTO qd_exchange_fill_events (
                ...
                account_scope, market_type, economic_order_id, intent_id,
            ...
            (
                ...
                scope.economic_order_id, scope.intent_id, venue_scope.exchange_order_id,
    ...
    def _insert_valuation_evidence(self, cursor: Cursor, fill_event_id: str, fill: FillLedgerInput) -> dict[str, str]:
    ...
    def _load_matching_replay(
        ...
        cursor.execute(
            ...
            SELECT id, tenant_id, credential_id, account_scope, market_type,
                   economic_order_id, intent_id, exchange_order_id, exchange_fill_id,
                   instrument_id, side, raw_payload_hash
              FROM qd_exchange_fill_events
             WHERE id = %s
             FOR UPDATE
            """,
            (fill_event_id,),
        ...
        observed = (
            ...
            str(_row_value(row, 6, "intent_id")), _row_value(row, 7, "exchange_order_id"),
        ...
        expected = (
            ...
            venue_scope.market_type, scope.economic_order_id, scope.intent_id,
