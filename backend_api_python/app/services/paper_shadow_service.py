...
from app.domain.strategy_library_contracts import StrategyLibraryError, StrategySignalFact, coerce_strategy_signal
...
class PaperShadowService:
    ...
    def decide(
        ...
        *,
        ...
        try:
            signal = coerce_strategy_signal(signal)
        except StrategyLibraryError as exc:
            raise PaperShadowServiceError("signal must be typed") from exc
