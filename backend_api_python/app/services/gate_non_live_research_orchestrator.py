...
from app.domain.backtest_cost_contracts import BacktestCostPolicySnapshot, BacktestLiquidityRole
...
from app.domain.strategy_library_contracts import StrategyDefinition, StrategyLibraryError, coerce_strategy_definition
    ...
    def run(
        ...
        *,
        ...
        try:
            ...
            raise GateNonLiveResearchError("strategy and sizing request must be typed") from exc
