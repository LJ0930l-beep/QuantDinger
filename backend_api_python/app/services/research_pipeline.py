...
from app.domain.strategy_library_contracts import StrategyDefinition, StrategySignalFact, StrategyLibraryError, coerce_strategy_definition, coerce_strategy_signal, strategy_fingerprint
...
class ResearchPipelineResult:
    ...
    def __post_init__(self) -> None:
        try:
            signal = coerce_strategy_signal(self.signal)
        except StrategyLibraryError as exc:
            raise ResearchPipelineError("pipeline result facts must be typed") from exc
        if not isinstance(self.sizing, PositionSizingDecision) or not isinstance(self.simulation, PaperShadowDecision):
    ...
    def evaluate(
        ...
        *,
        ...
        try:
            ...
            raise ResearchPipelineError("definition must be typed") from exc
    ...
    def evaluate_dataset(
        ...
        *,
        ...
        return self.evaluate(
            ...
            market_type=dataset.market_type if dataset.timeframe is not None else None,
            cooldown=cooldown,
            now=now,
        )
