...
def register_human_blueprints(api: Api) -> None:
    ...
    from app.openapi.routes.gate_testnet_execution import blp as gate_testnet_execution_blp
    from app.openapi.routes.paper_execution import blp as paper_execution_blp
